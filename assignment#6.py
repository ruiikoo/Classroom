...
string='Ruiikoo is the coolest developer'
n=1
while n<4:
    print(string)
    n+=1
...
# Print the count
string='Karaganda'
character_count=string.count('a')
...
# Print the string
string='My real name is Ruslan, but my nickname on all social media is "Ruiikoo".'
print(string)
